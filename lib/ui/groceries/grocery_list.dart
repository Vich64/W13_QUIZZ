...
enum _GroceryTab { groceryTab, searchTab}
class _GroceryListState extends State<GroceryList> {
  _GroceryListState _currentTab = GroceryList.groceryTab;
  void onCreate() async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     ...
     body: IndexedStack(
        ...
        children: [
          GroceryForm(grocery: widget.GroceryID),
          GrocerySubmission(GroceryId: widget.GroceryID),
        ],
      ),
